    ...
    <div class="flex-col justify-between">
      ...
      <div class="flex-auto px-0 pt-0 pb-2 space-x-5">
        <div class="p-4 overflow-x-auto">
            ...
            <!-- Data Table -->
            <table id="data-table" class="table-fixed w-full border-collapse border border-gray-200 text-slate-500">
                <thead class="bg-gray-100">
                    <tr>
                    <th class="px-4 py-2 text-left font-bold uppercase border border-gray-200">ID Chat</th>
                    <th class="px-4 py-2 text-left font-bold uppercase border border-gray-200">ID User</th>
                ...
                <tbody>
                    <tr v-for="(item, index) in tableData" :key="index" class="border border-gray-200 hover:bg-gray-100">
                    <td v-for="value in Object.values(item)" :key="value" class="px-4 py-2 border border-gray-200 text-gray-600">
                        {{ value }}
                    </td>
                    </tr>
                </tbody>
          ...
          <div class="flex flex-wrap justify-evenly gap-2 p-2 bg-white">
            <div class="flex-1 max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 m-4">
                ...
                <div class="p-5">
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-black">Base Knowledge</h5>
                    </a>
            ...
            <div class="flex-1 max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 m-4">
                ...
                <div class="p-5">
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-black">Admins</h5>
                    </a>
